        ...
        public partial class InitialCreate : Migration
    {
                protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                table: "Shipments",
                columns: new[] { "Id", "DeliveryDate", "Description", "DriverId", "FromAddress", "FromCountry", "FromTown", "PickUpDate", "Status", "ToAddress", "ToCountry", "ToTown", "VehicleId", "Weight" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 3, 10, 16, 0, 5, 727, DateTimeKind.Local).AddTicks(7847), "Electronics", null, "Sklad Kappa", "Bulgaria", "Kazanlak", new DateTime(2025, 3, 7, 16, 0, 5, 727, DateTimeKind.Local).AddTicks(7799), "Available", "Kaufland", "Bulgaria", "Plovdiv", null, 24.0 },
                    { 2, new DateTime(2025, 3, 12, 16, 0, 5, 727, DateTimeKind.Local).AddTicks(7855), "Furniture", null, "Sklad Videnov", "Bulgaria", "Stara Zagora", new DateTime(2025, 3, 7, 16, 0, 5, 727, DateTimeKind.Local).AddTicks(7854), "Available", "Metro", "Bulgaria", "Sofia", null, 27.0 }
                });            migrationBuilder.InsertData(
