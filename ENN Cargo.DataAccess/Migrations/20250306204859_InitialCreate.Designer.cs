...
namespace ENN_Cargo.DataAccess.Migrations
{
    ...
    [Migration("20250306204859_InitialCreate")]
            ...
            modelBuilder.Entity("ENN_Cargo.Models.Shipment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DeliveryDate = new DateTime(2025, 3, 9, 22, 48, 49, 647, DateTimeKind.Local).AddTicks(7060),
                            Description = "Electronics",
                            FromAddress = "Sklad Kappa",
                            FromCountry = "Bulgaria",
                            FromTown = "Kazanlak",
                            PickUpDate = new DateTime(2025, 3, 6, 22, 48, 49, 647, DateTimeKind.Local).AddTicks(6992),
                            Status = "Available",
                            ToAddress = "Kaufland",
                            ToCountry = "Bulgaria",
                            ToTown = "Plovdiv",
                        ...
                        {
                            Id = 2,
                            DeliveryDate = new DateTime(2025, 3, 11, 22, 48, 49, 647, DateTimeKind.Local).AddTicks(7073),
                            Description = "Furniture",
                            FromAddress = "Sklad Videnov",
                            FromCountry = "Bulgaria",
                            FromTown = "Stara Zagora",
                            PickUpDate = new DateTime(2025, 3, 6, 22, 48, 49, 647, DateTimeKind.Local).AddTicks(7070),
                            Status = "Available",
                            ToAddress = "Metro",
                            ToCountry = "Bulgaria",
                            ToTown = "Sofia",
